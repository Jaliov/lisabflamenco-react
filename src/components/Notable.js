    ...
    <Container>
      ...
      <Row>
        ...
        <Card className='bg-transparent'>
          ...
          <p class='card-text text-light larger'>
            Opening reception
            <br />
            The New York Public Library for the Performing Arts, Vincent Astor
            Gallery
          </p>
          <p class='card-text text-light'>Mar 12 - Aug 3, 2013</p>
          <SimpleReactLightbox>
            <SRLWrapper>
          ...
          <Card.Title className='text-warning'>
            ...
            <p class="text-light">March 24, 2012</p>
          </Card.Title>
          <SimpleReactLightbox>
            <SRLWrapper>
              <Card className='bg-transparent'>
